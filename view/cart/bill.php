...
<div class="privacy py-sm-5 py-4">
								...
								<div class="first-row">
									...
									<div class="controls form-group">
										<select class="option-w3ls" name="giaohang">
											...
											<option value="1" name="pttt">Thanh toán ATM</option>
											<option value="2" name="pttt">Nhận tiền tại nhà</option>
 ...
 <div class="checkout-right">
				...
				<table class="timetable_sub">
						<thead>
							<tr> <td colspan="" ><a href="index.php?act=billcf"><input type="button" class="btn btn-success" value="Đồng ý thanh toán" name="dongydathang"></a></td><tr>
						</thead>
					</table>
</div>
</div>